...
import { PageWrapper, ThemedBackground } from './styled'
...
export default function CompAccountPage({
  match: {
    params: { address },
  },
            ...
            <AutoColumn gap="lg">
              ...
              <ResponsiveRow>
                <StyledInternalLink to={networkPrefix(activeNetwork) + 'tokens/' + poolData.token0.address}>
                  <TokenButton>
                    <RowFixed>
                      <CurrencyAddressLogo address={poolData.token0.address} size={'20px'} />
                ...
                <StyledInternalLink to={networkPrefix(activeNetwork) + 'tokens/' + poolData.token1.address}>
                  <TokenButton ml="10px">
                    <RowFixed>
                      <CurrencyAddressLogo address={poolData.token1.address} size={'20px'} />
                      <TYPE.label fontSize="16px" ml="4px" style={{ whiteSpace: 'nowrap' }} width={'fit-content'}>
